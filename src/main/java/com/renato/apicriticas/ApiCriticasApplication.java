...
public class ApiCriticasApplication {
	...
	CommandLineRunner init(PostRepository postRepository) {
		return args -> {
			...
			Post post2 = new Post("A Jornada Épica dos Heróis", "cartazes/cartaz-a-jornada-epica-dos-herois.png", "A Jornada dos Heróis\", o tão aguardado filme fictício, é uma odisseia impressionante pelo mundo da imaginação que nos transporta para um universo repleto de magia, aventura e emoção. Dirigido com maestria por um talentoso cineasta, o longa-metragem cativa o público desde os primeiros minutos e o leva a uma jornada épica, repleta de reviravoltas e surpresas emocionantes.",
					Arrays.asList("aventura", "medieval"));
			Post post3 = new Post("A Jornada Épica dos Heróis", "cartazes/cartaz-a-jornada-epica-dos-herois.png", "A Jornada dos Heróis\", o tão aguardado filme fictício, é uma odisseia impressionante pelo mundo da imaginação que nos transporta para um universo repleto de magia, aventura e emoção. Dirigido com maestria por um talentoso cineasta, o longa-metragem cativa o público desde os primeiros minutos e o leva a uma jornada épica, repleta de reviravoltas e surpresas emocionantes.",
					Arrays.asList("aventura", "medieval"));
			Post post4 = new Post("A Jornada Épica dos Heróis", "cartazes/cartaz-a-jornada-epica-dos-herois.png", "A Jornada dos Heróis\", o tão aguardado filme fictício, é uma odisseia impressionante pelo mundo da imaginação que nos transporta para um universo repleto de magia, aventura e emoção. Dirigido com maestria por um talentoso cineasta, o longa-metragem cativa o público desde os primeiros minutos e o leva a uma jornada épica, repleta de reviravoltas e surpresas emocionantes.",
					Arrays.asList("aventura", "medieval"));
			Post post5 = new Post("No Limite da Realidade", "cartazes/cartaz-no-limite-da-realidade.png", "No Limite da Realidade\" é uma obra cinematográfica que desafia os limites da imaginação, transportando o espectador para um mundo fantástico e misterioso. Dirigido com maestria, o filme nos leva a uma viagem inesquecível, explorando temas complexos e surpreendentes que mantêm o público intrigado do início ao fim.",
					Arrays.asList("romance"));
			Post post6 = new Post("No Limite da Realidade", "cartazes/cartaz-no-limite-da-realidade.png", "No Limite da Realidade\" é uma obra cinematográfica que desafia os limites da imaginação, transportando o espectador para um mundo fantástico e misterioso. Dirigido com maestria, o filme nos leva a uma viagem inesquecível, explorando temas complexos e surpreendentes que mantêm o público intrigado do início ao fim.",
					Arrays.asList("romance"));
			Post post7 = new Post("No Limite da Realidade", "cartazes/cartaz-no-limite-da-realidade.png", "No Limite da Realidade\" é uma obra cinematográfica que desafia os limites da imaginação, transportando o espectador para um mundo fantástico e misterioso. Dirigido com maestria, o filme nos leva a uma viagem inesquecível, explorando temas complexos e surpreendentes que mantêm o público intrigado do início ao fim.",
					Arrays.asList("romance"));
			Post post8 = new Post("No Limite da Realidade", "cartazes/cartaz-no-limite-da-realidade.png", "No Limite da Realidade\" é uma obra cinematográfica que desafia os limites da imaginação, transportando o espectador para um mundo fantástico e misterioso. Dirigido com maestria, o filme nos leva a uma viagem inesquecível, explorando temas complexos e surpreendentes que mantêm o público intrigado do início ao fim.",
					Arrays.asList("romance"));
